...
import config
from FlexX import Carbon, YouTube, app
from FlexX.core.call import Flex
from FlexX.misc import db
from FlexX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from FlexX.utils.exceptions import AssistantErr
from FlexX.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from FlexX.utils.inline.playlist import close_markup
from FlexX.utils.pastebin import Flexbin
from FlexX.utils.stream.queue import put_queue, put_queue_index
from FlexX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Flex.force_stop_stream(chat_id)
