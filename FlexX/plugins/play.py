...
from FlexX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from FlexX.core.call import Flex
from FlexX.utils import seconds_to_min, time_to_seconds
from FlexX.utils.channelplay import get_channeplayCB
from FlexX.utils.database import is_video_allowed
from FlexX.utils.decorators.language import languageCB
from FlexX.utils.decorators.play import PlayWrapper
from FlexX.utils.formatters import formats
from FlexX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from FlexX.utils.inline.playlist import botplaylist_markup
from FlexX.utils.logger import play_logs
from FlexX.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("FlexymousAdmin") & ~BANNED_USERS
)
async def Flexymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("FlexPlaylists") & ~BANNED_USERS
)
@languageCB
