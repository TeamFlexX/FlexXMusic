HELP_1 = """🙄 **<u>اوامر المشرف:</u>**

- فقط اضف **ᴄ** في بداية الاوامر لاستخدامها في القناةز.

/pause : ايقاف تشغيل البث.

/resume : استئناف البث مؤقتا.

/skip : لتخطي الاغمنيه و البدء في بث الاغنيه الاخري.

/end ᴏʀ /stop : لمسح قائمه الانتظار في البوت و انهاء الاغنيه.

/player : للحصول علي الاشخاص المتفاعلين.

/queue : لاظهار قائمه المسارات."""
