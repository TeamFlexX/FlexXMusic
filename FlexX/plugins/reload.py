...
from FlexX.utils.database import get_authuser_names, get_cmode
from FlexX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from FlexX.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Flex.stop_stream(message.chat.id)
    except:
        pass
